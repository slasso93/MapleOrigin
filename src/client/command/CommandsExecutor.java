...
import client.command.commands.gm0.MobHpCommand;
import client.command.commands.gm0.BossHpCommand;
...
public class CommandsExecutor {
    ...
    private void handleInternal(MapleClient client, String message){
        ...
        if (command == null){
            client.getPlayer().yellowMessage("Command '" + commandName + "' is not available. Please use @commands for a list of all available commands.");
            return;
        }
    ...
    private void registerLv0Commands(){
       ...
       // addCommand(new String[]{"help", "commands"}, HelpCommand.class);
        addCommand("checkBoss", BossLogCommand.class);
