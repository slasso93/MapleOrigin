...
public class DropRateCommand extends Command {
    ...
    public void execute(MapleClient c, String[] params) {
        ...
        c.getWorldServer().broadcastPacket(MaplePacketCreator.serverNotice(6, "[Rate] Drop Rate has been changed to " + droprate + "x the usual."));
