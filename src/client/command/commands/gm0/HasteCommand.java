...
public class HasteCommand extends Command {
    {
        setDescription("Casts the Haste Skill on all players in the area");
    }

    @Override
    public void execute(MapleClient c, String[] params) {
        MapleCharacter player = c.getPlayer();
        SkillFactory.getSkill(4101004).getEffect(SkillFactory.getSkill(4101004).getMaxLevel() - 1).applyTo(player);//Haste
