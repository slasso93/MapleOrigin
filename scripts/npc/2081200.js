                ...
                if(status == 0) {
                        ...
                        if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
                            if (cm.getPlayer().getRemainingSp() > 0) {
                                ...
                                if(cm.getJobId() == 212) {
                                        if(cm.getPlayer().getSkillLevel(2121001) == 0)
                                                cm.teachSkill(2121001 , 0, 10, -1);
                                        if(cm.getPlayer().getSkillLevel(2121002) == 0)
                                                cm.teachSkill(2121002 , 0, 10, -1);
                                        ...
                                        if(cm.getPlayer().getSkillLevel(2221001) == 0)
                                                cm.teachSkill(2221001 , 0, 10, -1);
                                        if(cm.getPlayer().getSkillLevel(2221002) == 0)
                                                cm.teachSkill(2221002 , 0, 10, -1);
