...
function start() {
	if (cm.getPlayer().getPosition().getX() < -1828.0 || cm.getPlayer().getPosition().getX() > -1497.0 || cm.getPlayer().getPosition().getY() > -1586.0) { // TODO: there's probably a better way to do this
		cm.sendOk("What are you doing out there on the obstacle course?");
		cm.dispose();
	} else {
