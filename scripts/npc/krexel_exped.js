...
var player;
var em;
var exped = MapleExpeditionType.KREXEL;
var expedName = "Krexel";
var expedBoss = "Krexel";
var expedMap = "Ruins of Krexel II";
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("KrexelBattle");
    ...
    if (mode == -1) {
		...
		if (player.getQuestStatus(4530) >= 1) {
			if (status == 0) {
