...
var mface = new Array(23086, 24012, 25025, 25011, 21078, 25050,23029, 23033, 23040, 23057, 23055, 23069, 23073, 23072, 23084, 23079, 24001, 25013, 25014, 25015, 25018, 25019, 25020, 25022, 25024, 25027, 25031, 25056, 25039, 25079);
var fface = new Array(25044, 24079, 26096, 28020, 27017, 27053, 21094, 21077, 21076, 21070, 21084, 21081, 21079, 24005, 24008, 24010, 24012, 24013, 24015, 24015, 24022, 24029, 24028, 24027, 24020, 24037, 24041, 24055, 24060, 24064, 24072, 24081, 24082, 24093, 24092, 24098, 25006, 25038, 25083, 26028);
var beauty = -1;
...
function start() {
    ...
    cm.sendSimple("Hi! I can exchange #v4000492# for various donor items! What would u like to buy? (More to come!)#b\r\n" + 
			...
			"#L5# Haircut for 5 CoGT [BUG: Choose hair color before haircut. Working on fix. \r\n" +
